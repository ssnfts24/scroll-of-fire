...
test('B7.53 has a fresh cache/app identity', () => {
  assert.match(sphere, /living-time-sphere-renderer-3d\.js\?v=20260819-b7523&r=20260820-b757/);
  assert.match(sphere, /living-time-sphere\.css\?v=20260819-b752&r=20260820-b757/);
  assert.match(version, /APP_VERSION = "2026\.08\.20\.(?:53|54|55|56|57)"/);
});
